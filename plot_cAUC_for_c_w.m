...
for fm = 1:3
    ...
    for am = 1:3
        ...
        netLSTM = load(fullfile(path,Animal,'ana',strcat('LSTM_21_25_LF_HF_',num2str(frame(1)),'_',num2str(frame(end)),'_','AC5f.mat')));
        ...
        PF = load(fullfile(path,Animal,'ana',strcat('PF_10fold_LSTM_21_25_LF_HF_',num2str(frame(1)),'_',num2str(frame(end)),'_','AC5f.mat')));
        PF = PF.Performance;
        avgPF = mean(PF,1);
        ACC_c(am,5) = avgPF(1);
        AUC_c(am,5) = avgPF(2);
